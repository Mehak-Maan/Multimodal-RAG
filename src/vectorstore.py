...
# SQLiteRecordManagerRetriever is optional; not required in this implementation

from langchain_classic.indexes import SQLRecordManager, index as index_docs
